...
<div class="panel template-panel">
    ...
    <div class="panel-body">
        <form class="validate" action="<?=Helper\Link::route('template/save', null, true)?>" method="post">
            <?=Helper\Protection::viewPublicTokenField()?>

            <div class="row">
                <div class="col-sm-8">
                    <label for="title">Title</label>
                    <input type="text" id="title" class="form-control validate[required,minSize[3],maxSize[45]]" maxlength="45" name="title" placeholder="Template Title">
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <br>
                    <button class="btn btn-primary col-sm-12" type="submit">Create Template</button>
                </div>
            </div>
        </form>
    </div>
